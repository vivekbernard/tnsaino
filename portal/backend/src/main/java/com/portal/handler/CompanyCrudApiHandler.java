...
public class CompanyCrudApiHandler {
    ...
    private static final Set<String> HANDLED_ROUTES = Set.of(
            ROUTE_PUT_COMPANY, ROUTE_GET_COMPANY, ROUTE_GET_COMPANY_LIST,
