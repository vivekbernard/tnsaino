...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // After login, checkAuth runs and updates user/role.
      // We need to wait a tick for state to settle then redirect.
      // The redirect will happen on next render via the check above.
    } catch (err) {
